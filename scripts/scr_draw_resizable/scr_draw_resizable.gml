/// @description  scr_draw_resizable(sprite_index, width, height, pivot_x, pivot_y)
/// @param sprite_index
/// @param  width
/// @param  height
/// @param  pivot_x
/// @param  pivot_y
function scr_draw_resizable(argument0, argument1, argument2, argument3, argument4, scale) {
	/*
