/// @description  scr_draw_resizable(sprite_index, x, y, width, height, pivot_x, pivot_y)
/// @param sprite_index
/// @param  x
/// @param  y
/// @param  width
...
/// @param  pivot_x
/// @param  pivot_y
function draw_resizable_ext(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
	/*
